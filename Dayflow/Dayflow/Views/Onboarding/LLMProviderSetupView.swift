    ...
    case .apiKeyInput:
      VStack(alignment: .leading, spacing: 24) {
        ...
        VStack(alignment: .leading, spacing: 12) {
          Text(
            "Choose your Gemini model. If you're on the free tier, pick 3 Flash, it's the most powerful model and is completely free to use. If you're on a paid plan, which is not recommended, I recommend 2.5 Flash-Lite to minimize costs."
          )
          .font(.custom("Nunito", size: 16))
          .fontWeight(.semibold)
          .foregroundColor(.black.opacity(0.85))
