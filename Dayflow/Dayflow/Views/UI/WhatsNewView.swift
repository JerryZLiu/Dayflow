  ...
  static var configuredRelease: ReleaseNote? {
    ReleaseNote(
      ...
      cta: ReleaseNoteCTA(
        title: "Standup Pilot",
        description:
          "I'm piloting a workflow to make standups and weekly 1:1 prep less painful. I'm personally onboarding the first 10 users to work out the kinks, so please book a time if you're interested!",
